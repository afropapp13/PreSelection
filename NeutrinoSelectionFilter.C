...
//		TString PathToPOTFile = "/pnfs/uboone/persistent/users/apapadop/mySamples/"+UBCodeVersion+"/PeLEETuples/PreSelection_"+fLabel+"_"+UBCodeVersion+"_POT.root";
	...
	for (Long64_t jentry=0; jentry<nentries;jentry++) {
		...
		if (string(fLabel).find("Overlay") != std::string::npos) {
			...
			if ( 
				fLabel == "Overlay9_Run1" || fLabel == "Overlay9_Run2" || fLabel == "Overlay9_Run3" || 
				fLabel == "Overlay9_Run4" || fLabel == "Overlay9_Run4a" || fLabel == "Overlay9_Run4aRutgers" || 
				fLabel == "Overlay9_Run4b" || fLabel == "Overlay9_Run5" || fLabel == "Overlay9_Run5a" ||
				fLabel == "OverlayDirt9_Run1" || fLabel == "OverlayDirt9_Run2" || 
				fLabel == "OverlayDirt9_Run3" || fLabel == "OverlayDirt9_Run4a" ||fLabel == "OverlayDirt9_Run4aRutgers" || 
