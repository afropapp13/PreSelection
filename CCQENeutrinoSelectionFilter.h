#ifndef CCQENeutrinoSelectionFilter_h
#define CCQENeutrinoSelectionFilter_h
...
class CCQENeutrinoSelectionFilter {
...
/*   TBranch        *b_knobThetaDelta2Npidn;   //! */
   ...
   CCQENeutrinoSelectionFilter(TString Label = "", TString Sample = "", TTree *tree=0);
   virtual ~CCQENeutrinoSelectionFilter();
...
#ifdef CCQENeutrinoSelectionFilter_cxx
CCQENeutrinoSelectionFilter::CCQENeutrinoSelectionFilter(TString Label, TString Sample, TTree *tree) : fChain(0) {
...
CCQENeutrinoSelectionFilter::~CCQENeutrinoSelectionFilter()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CCQENeutrinoSelectionFilter::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CCQENeutrinoSelectionFilter::LoadTree(Long64_t entry)
{
...
void CCQENeutrinoSelectionFilter::Init(TTree *tree)
{
...
Bool_t CCQENeutrinoSelectionFilter::Notify()
{
...
void CCQENeutrinoSelectionFilter::Show(Long64_t entry)
{
...
Int_t CCQENeutrinoSelectionFilter::Cut(Long64_t entry)
{
...
#endif // #ifdef CCQENeutrinoSelectionFilter_cxx
