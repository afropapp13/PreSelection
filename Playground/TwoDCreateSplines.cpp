...
void ReturnGraph(TTree* tree, TString qualifier, TString XVar, bool StorePlots) {
...
void TwoDCreateSplines(TString Sample, bool StorePlots = false) {
...
//	TString Qualifier = qualifier + " && CandidateP_CosTheta > -1 && CandidateP_CosTheta < 0.1";
//	TString Qualifier = qualifier + " && CandidateP_CosTheta > 0.1 && CandidateP_CosTheta < 0.4";
//	TString Qualifier = qualifier + " && CandidateP_CosTheta > 0.4 && CandidateP_CosTheta < 0.7";
//	TString Qualifier = qualifier + " && CandidateP_CosTheta > 0.7 && CandidateP_CosTheta < 0.85";
	TString Qualifier = qualifier + " && CandidateP_CosTheta > 0.85 && CandidateP_CosTheta < 1.";

	ReturnGraph(tree,Qualifier,"CandidateP_P_Range",StorePlots);
