...
void ReturnGraph(TFile* OutputFile, TTree* tree, TString qualifier, TString XVar, bool StorePlots) {
	...
	double ResoFitMin = -20., ResoFitMax = 20.;
...
//	if (XVar == "CandidateMu_P_Range") { 
		...
		FitMin = -0.2; FitMax = 0.2;
		XminReso = -0.4; XmaxReso = 0.4;
		NBinsReso = 6;
		ResoAxisLabel = ";P_{#mu} Range resolution [%];# Events;"; 
		ResoRatio = "(CandidateMu_P_MCS-CandidateMu_P_Range)/CandidateMu_P_Range*100.";
		...
		Reso = "(CandidateMu_P_MCS-CandidateMu_P_Range)";
...
//		ResoRatio = "(CandidateMu_P_MCS-CandidateMu_P_Range)/True_CandidateMu_P*100.";
...
void Mastbaum_CreateSplines(TString Sample, bool StorePlots = false) {
...
//	ReturnGraph(OutputFile,tree,qualifierData + " && NuScore > 0.4 && CandidateMu_Length > 100","CandidateMu_P_Range",StorePlots);
	ReturnGraph(OutputFile,tree,qualifier + " && NuScore > 0.4 && CandidateMu_Length > 100","CandidateMu_P_Range",StorePlots);
