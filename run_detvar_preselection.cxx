{
	...
	WhichSampleArray.push_back("Overlay9_Run4_CV"); SamplePath.push_back("/pnfs/uboone/persistent/users/cthorpe/PELEE_2023/run4_detvar/Detvar_BNB_nu_pandora_reco2_CV_run4_reco2_ana.root");
	WhichSampleArray.push_back("Overlay9_Run4_LYDown"); SamplePath.push_back("/pnfs/uboone/persistent/users/cthorpe/PELEE_2023/run4_detvar/run4_5_bnb_nu_overlay_detvar_LYDown_reco2_pandora_unified_run4_ana.root");
	WhichSampleArray.push_back("Overlay9_Run4_LYRayleigh"); SamplePath.push_back("/pnfs/uboone/persistent/users/cthorpe/PELEE_2023/run4_detvar/run4_5_bnb_nu_overlay_detvar_LYRayleigh_reco2_pandora_unified_run4_ana.root");
	WhichSampleArray.push_back("Overlay9_Run4_LYAttenuation"); SamplePath.push_back("/pnfs/uboone/persistent/users/cthorpe/PELEE_2023/run4_detvar/Run_4_BNB_Nu_Detvar_LYAttenuation_Pandora_Reco2_run4_ana.root");
	WhichSampleArray.push_back("Overlay9_Run4_X"); SamplePath.push_back("/pnfs/uboone/persistent/users/cthorpe/PELEE_2023/run4_detvar/run4_bnb_nu_detvar_wiremod_x_pandora_reco2_reco2_ana.root");
